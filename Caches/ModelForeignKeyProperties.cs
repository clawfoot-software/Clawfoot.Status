...
namespace Clawfoot.Utilities.Caches
{
    ...
    /// </summary>
    internal class ModelForeignKeyProperties
    {
        ...
        internal ModelForeignKeyProperties(Type type)
        {
            Type = type;
        ...
        internal bool Add(PropertyInfo property, ForeignKeyAttribute attribute, PropertyInfo foreignKeyReferenceProperty)
        {
            return ModelPropertiesDict.TryAdd(property.Name, new ForeignKeyProperty(property, attribute, foreignKeyReferenceProperty));
        }

        internal List<ForeignKeyProperty> GetList()
        {
            //Caching list
